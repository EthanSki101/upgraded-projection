...
const regionsData = {
  west: {
    ...
    districts: [
      { name: 'Noida (Gautam Buddha Nagar)', pop: '4.9M', area: '1,282', density: '3,822', edu: '97.2%', urban: '99.2%', growth: '14.2%', hindu: 84.6, muslim: 13.1, other: 2.3, gdp: '240' },
      { name: 'Ghaziabad (Smart Transit)', pop: '7.1M', area: '1,179', density: '6,022', edu: '94.6%', urban: '96.5%', growth: '10.8%', hindu: 72.9, muslim: 25.3, other: 1.8, gdp: '145' },
      { name: 'Agra (Tourism/Mfg)', pop: '6.3M', area: '4,027', density: '1,564', edu: '87.5%', urban: '71.8%', growth: '7.1%', hindu: 88.8, muslim: 9.3, other: 1.9, gdp: '84' },
      { name: 'Meerut (Sports/Tech)', pop: '5.8M', area: '2,522', density: '2,300', edu: '89.3%', urban: '78.6%', growth: '8.9%', hindu: 63.4, muslim: 34.4, other: 2.2, gdp: '76' },
      { name: 'Aligarh (Hardware Hub)', pop: '5.3M', area: '3,650', density: '1,452', edu: '84.2%', urban: '61.7%', growth: '9.1%', hindu: 79.1, muslim: 19.8, other: 1.1, gdp: '56' },
      { name: 'Mathura (Pilgrimage/Oil)', pop: '3.9M', area: '3,340', density: '1,168', edu: '85.8%', urban: '63.2%', growth: '7.6%', hindu: 90.5, muslim: 8.5, other: 1.0, gdp: '49' },
    ],
    insights: [
  ...
  awadh: {
    ...
    districts: [
      { name: 'Lucknow (Admin/Services)', pop: '8.2M', area: '2,528', density: '3,244', edu: '94.1%', urban: '91.6%', growth: '11.8%', hindu: 71.7, muslim: 26.4, other: 1.9, gdp: '155' },
      { name: 'Kanpur Nagar (Ind. Forge)', pop: '7.4M', area: '3,155', density: '2,345', edu: '91.2%', urban: '85.9%', growth: '7.2%', hindu: 82.5, muslim: 15.7, other: 1.8, gdp: '129' },
      { name: 'Ayodhya (Global Heritage)', pop: '4.6M', area: '2,522', density: '1,824', edu: '85.4%', urban: '54.8%', growth: '16.6%', hindu: 84.8, muslim: 14.8, other: 0.4, gdp: '66' },
      { name: 'Unnao (Logistics Hub)', pop: '4.8M', area: '4,558', density: '1,053', edu: '85.3%', urban: '49.9%', growth: '10.4%', hindu: 88.1, muslim: 11.5, other: 0.4, gdp: '45' },
      { name: 'Sitapur (Agri-Tech)', pop: '6.4M', area: '5,743', density: '1,114', edu: '80.6%', urban: '31.7%', growth: '7.8%', hindu: 79.3, muslim: 19.9, other: 0.8, gdp: '39' },
      { name: 'Barabanki (Warehouse)', pop: '5.1M', area: '4,402', density: '1,158', edu: '82.1%', urban: '41.6%', growth: '8.7%', hindu: 76.6, muslim: 22.6, other: 0.8, gdp: '43' },
    ],
    insights: [
  ...
  east: {
    ...
    districts: [
      { name: 'Varanasi (Culture/Trade)', pop: '5.9M', area: '1,535', density: '3,844', edu: '90.7%', urban: '71.9%', growth: '11.6%', hindu: 84.5, muslim: 14.8, other: 0.7, gdp: '112' },
      { name: 'Prayagraj (Edu/Admin)', pop: '9.1M', area: '5,482', density: '1,660', edu: '88.9%', urban: '51.8%', growth: '8.9%', hindu: 85.6, muslim: 13.3, other: 1.1, gdp: '122' },
      { name: 'Gorakhpur (Health/Tech)', pop: '7.1M', area: '3,321', density: '2,138', edu: '87.3%', urban: '49.7%', growth: '12.1%', hindu: 90.2, muslim: 9.1, other: 0.7, gdp: '95' },
      { name: 'Azamgarh (Agri-Business)', pop: '6.6M', area: '4,054', density: '1,628', edu: '81.9%', urban: '28.9%', growth: '5.4%', hindu: 84.1, muslim: 15.5, other: 0.4, gdp: '48' },
      { name: 'Jaunpur (Remittance/Edu)', pop: '6.3M', area: '4,038', density: '1,560', edu: '82.8%', urban: '23.5%', growth: '4.8%', hindu: 88.5, muslim: 10.7, other: 0.8, gdp: '44' },
      { name: 'Ghazipur (River Transit)', pop: '4.9M', area: '3,377', density: '1,451', edu: '83.6%', urban: '20.6%', growth: '6.2%', hindu: 89.3, muslim: 10.1, other: 0.6, gdp: '35' },
    ],
    insights: [
  ...
  bundel: {
    ...
    districts: [
      { name: 'Jhansi (Defense/Transit)', pop: '3.2M', area: '5,024', density: '637', edu: '87.6%', urban: '64.7%', growth: '10.3%', hindu: 88.5, muslim: 9.8, other: 1.7, gdp: '63' },
      { name: 'Lalitpur (Mining/Solar)', pop: '2.1M', area: '5,039', density: '417', edu: '80.4%', urban: '29.8%', growth: '7.1%', hindu: 92.5, muslim: 5.5, other: 2.0, gdp: '29' },
      { name: 'Banda (Agri/Trade)', pop: '2.7M', area: '4,408', density: '612', edu: '82.1%', urban: '31.6%', growth: '5.3%', hindu: 91.0, muslim: 8.5, other: 0.5, gdp: '24' },
      { name: 'Jalaun (Solar/Industrial)', pop: '2.4M', area: '4,565', density: '526', edu: '83.5%', urban: '38.9%', growth: '8.4%', hindu: 89.5, muslim: 10.1, other: 0.4, gdp: '28' },
      { name: 'Mahoba (Heritage/Water)', pop: '1.4M', area: '3,144', density: '445', edu: '78.2%', urban: '34.7%', growth: '4.9%', hindu: 93.4, muslim: 6.2, other: 0.4, gdp: '13' },
      { name: 'Chitrakoot (Tourism)', pop: '1.6M', area: '3,216', density: '497', edu: '79.1%', urban: '24.2%', growth: '5.8%', hindu: 95.5, muslim: 4.2, other: 0.3, gdp: '14' },
    ],
    insights: [
      ...
      <div className="relative z-10 mx-auto max-w-7xl space-y-10">
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
          <section className="xl:col-span-2">
            <div className="h-full rounded-3xl border border-white/10 bg-white/10 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.24)] backdrop-blur-xl lg:p-8">
